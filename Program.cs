...
//         // Вызываем функцию,
//         // Этот код выводит элементы массива array начиная с конца. В данном примере будет выведено: 5, 4, 3, 2, 1. передавая ей исходный массив и индекс последнего элемента
